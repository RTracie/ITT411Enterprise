	...
	<title><?php echo $_SESSION['Personelle'];?>'s Homepage</title>
     <style>
       .menu{
        ...
        .studentDrop:hover .studentbtn, .lecturerDrop:hover .lecturerbtn, .coursesDrop:hover .coursebtn {
     ...
     <script>
        ...
        function personalinfo(){ //not used, can be removed or used if you see fit
            document.getElementById("workspace").innerHTML='<object type="text/html" data=" " style="width:100%; height:100%;"></object>>'
        }
    </script>
</head>
<body>
